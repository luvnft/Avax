...
//   // function createMemeToken(string memory name, string memory symbol, string memory imageUrl, string memory description)
//   console.log("\nCreating MemeToken...");
...
//   console.log("MemeToken created in transaction:", receipt.transactionHash);

//   // function getAllMemeTokens() public view returns (memeToken[] memory)
//   // console.log("\nGetting all meme tokens...");
//   // const memeTokenAddress = await tokenFactory.memeTokenAddresses(0);
//   // console.log("MemeToken address at index 0:", memeTokenAddress);
// }
