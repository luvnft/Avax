...
// adds specific configuration for BondingCurvePrecompile.
type Config struct {
...
// that disables BondingCurvePrecompile.
...
// Key returns the key for the BondingCurvePrecompile precompileconfig.
